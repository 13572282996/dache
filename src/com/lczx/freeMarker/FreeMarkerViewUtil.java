...
import com.lczx.util.EnumConverter;
...
public class FreeMarkerViewUtil
{
            ...
            throws IOException, TemplateException
    {
        ...
        {
            FreeMarkerConfigurer freeMarkerConfigurer = SpringUtils.getBean("freemarkerConfig",
            ...
            Configuration configuration) throws IOException, TemplateException
    {
        ...
        new Template("template", new StringReader(template), configuration).process(model,
                out);
        return out.toString();
    }
