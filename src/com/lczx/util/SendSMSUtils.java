 ...
 * @author Administrator
 * @version [1.0 2016年7月16日]
 * Copyright: Copyright (c) LCZXTECH Co.,Ltd. 2014
 * Company:成都联创众享科技有限公司 www.lczxtech.com
 */
public class SendSMSUtils
{
    ...
    static final String accessKeyId = "LTAI5Mb9eHgD25Uv";
    
    static final String accessKeySecret = "XbpL9IfXAL6aiO66c4DsRTH7lRTZlw";
    ...
    public static SendSmsResponse sendSms(String mobile,String code) throws ClientException
    {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("小孙专车");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_133977837");
...
//                && "OK".equals(sendSmsResponse.getMessage()))
//        {
//            Code code1 = new Code();
...
//        }
            ...
            throws ClientException
    {
        ...
        //必填-号码
        request.setPhoneNumber("15881087682");
        //可选-流水号
            ...
            InterruptedException
    {
        ...
        //        //发短信
       //        SendSmsResponse response = sendSms("15881087682");
