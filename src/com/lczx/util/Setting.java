...
public class Setting implements Serializable
{
     ...
     * 
     */
    private static final long serialVersionUID = 4866533742112692293L;
    ...
    /**司机取消次数*/
    private Integer driverCancellNum;
    
    /**乘客取消次数*/
    private Integer memberCancellNum;
    ...
    public void setReceiveScope(Integer receiveScope)
    {
        this.receiveScope = receiveScope;
    }

    public Integer getDriverCancellNum()
    {
        return driverCancellNum;
    }

    public void setDriverCancellNum(Integer driverCancellNum)
    {
        this.driverCancellNum = driverCancellNum;
    }

    public Integer getMemberCancellNum()
    {
        return memberCancellNum;
    }

    public void setMemberCancellNum(Integer memberCancellNum)
    {
        this.memberCancellNum = memberCancellNum;
    }
