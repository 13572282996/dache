...
import com.lczx.template.directive.FlashMessageDirective;
import com.lczx.util.DateEditor;
...
public class BaseController
{
    ...
    protected boolean isValid(Class<?> type, String property, Object value,
            Class<?>... groups)
    {
        Set<?> constraintViolations = validator.validateValue(type,
                property,
                value,
                groups);
        if (constraintViolations.isEmpty())
