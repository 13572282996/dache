...
public class ApiController extends BaseController
{
    ...
    public static void main(String[] args)
    {
        ...
        int service_id = 11368217;//注意这里是服务的id不是应用的id  
        String entity_name = "袁文波";  
        double latitude = 30;  
        double longitude = 20;  
        ...
        ApiController api1 = new ApiController();
        String str = api1.sendPost(url, param);  
