...
//import com.lczx.shiro.Principal;
        ...
        AdminService
{
    ...
    public List<String> findAuthorities(Long id)
    {
        ...
        if (admin != null)
        {
            ...
            {
                List<com.lczx.entity.Resource> resources = role.getResources();
                for (com.lczx.entity.Resource resource : resources)
                {
                    authorities.add(resource.getMark());
                }
            }
        }
        return authorities;
    ...
    public Admin getCurrent()
    {
        ...
        if (subject != null)
        {
//        	Principal principal = (Principal) subject.getPrincipal();不使用principal
