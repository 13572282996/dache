...
import com.lczx.dao.BaseDao;
import com.lczx.entity.OrderEntity;
        ...
        BaseDao<T, ID>
{
            ...
            Integer count, List<Filter> filters, List<Order> orders)
    {
        ...
        {
        	//Class.isAssignableFrom(Class clz)方法判断一个类是否是另一个类的父类 
            ...
            List<Filter> filters)
    {
        ...
        for (Filter filter : filters)
        {
                    ...
                    && filter.getValue() != null)
            {
                ...
                {
                    restrictions = criteriaBuilder.and(restrictions,
                            criteriaBuilder.equal(root.get(filter.getProperty()),
                                    filter.getValue()));
                }
            }
                    ...
                    && filter.getValue() != null)
            {
                ...
                {
                    restrictions = criteriaBuilder.and(restrictions,
                            criteriaBuilder.notEqual(root.get(filter.getProperty()),
                                    filter.getValue()));
                }
            }
