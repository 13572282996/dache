        ...
        implements ArticleCategoryDao
{
    ...
    public List<ArticleCategory> findRoots(Integer count)
    {
        ...
        TypedQuery<ArticleCategory> query = entityManager.createQuery(jpql,
			...
			ArticleCategory articleCategory, Integer count) 
	{
        ...
        if (articleCategory != null)
        {
            ...
            query = entityManager.createQuery(jpql, ArticleCategory.class)
                    .setFlushMode(FlushModeType.COMMIT)
                    .setParameter("parent", articleCategory);
        }
        else
        {
            String jpql = "select articleCategory from ArticleCategory articleCategory order by articleCategory.order asc";
     ...
     * @return 文章分类
     */
    private List<ArticleCategory> sort(List<ArticleCategory> articleCategories,
            ArticleCategory parent)
    {
        ...
        if (articleCategories != null)
        {
            ...
            {
                if ((articleCategory.getParent() != null && articleCategory.getParent()
                        .equals(parent))
    ...
    private void setValue(ArticleCategory articleCategory)
    {
        ...
        if (parent != null)
        {
            articleCategory.setTreePath(parent.getTreePath() + parent.getId()
                    + ArticleCategory.TREE_PATH_SEPARATOR);
        }
        else
        {
