...
public class SnDaoImpl implements SnDao, InitializingBean
{
    ...
    private HiloOptimizer templateHiloOptimizer;
    ...
    @Value("${sn.template.prefix}")
    private String templatePrefix;
    
    @Value("${sn.template.maxLo}")
    private int templateMaxLo;
    
    public void afterPropertiesSet() throws Exception
    {
        productHiloOptimizer = new HiloOptimizer(Type.product, productPrefix,
                productMaxLo);
        orderHiloOptimizer = new HiloOptimizer(Type.order, orderPrefix,
                orderMaxLo);
        paymentHiloOptimizer = new HiloOptimizer(Type.payment, paymentPrefix,
                paymentMaxLo);
        refundsHiloOptimizer = new HiloOptimizer(Type.refunds, refundsPrefix,
                refundsMaxLo);
        shippingHiloOptimizer = new HiloOptimizer(Type.shipping,
                shippingPrefix, shippingMaxLo);
        returnsHiloOptimizer = new HiloOptimizer(Type.returns, returnsPrefix,
                returnsMaxLo);
        templateHiloOptimizer = new HiloOptimizer(Type.template,
                templatePrefix, templateMaxLo);
    }
    ...
    public String generate(Type type)
    {
        ...
        {
            return templateHiloOptimizer.generate();
        }
        return null;
    }
