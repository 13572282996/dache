...
-->      
        <ul class="breadcrumb">
            ...
            <li class="active">${message("admin.resource.list")}</li> (${message("admin.page.total", page.total)})
        </ul>
...
<form id="inputForm" action="save.jhtml" class="form-inline" method="post" enctype="multipart/form-data">
    ...
    <table class="layui-table" id="addEditTable">
		<tr>
				...
				<td>
					<input type="text" name="groupName" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="mark" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
     ...
     <tr>
						...
						[#list page.content as resource]
							<tr>
								...
								<td style="text-align:center">
									<a href="edit.jhtml?id=${resource.id}"  class="layui-btn layui-btn-xs">${message("admin.common.edit")}</a>
