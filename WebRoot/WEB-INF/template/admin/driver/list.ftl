...
<!--指定按名称搜索	<select name="searchProperty" class="listselect">
	...
	<input type="hidden" name="searchProperty" value="driverName" />
...
<div class="well" style="margin-bottom: 0px;padding-bottom: 0px;overflow:scroll; width:96.3%;">
    <table class="layui-table" id="listTable"  style="width:2000px;text-align:center;white-space: nowrap">
     <tr>
							<th class="check" style="text-align:center">
								<input type="checkbox"  style="felt:10px;" id="selectAll" />
							</th>
							<th style="text-align:center">
								<a href="javascript:;" class="sort" name="driverName">姓名</a>
							</th>
							<th style="text-align:center">
								<a href="javascript:;" class="sort" name="username">性别</a>
							</th>
							<th style="text-align:center">
								<a href="javascript:;" class="sort" name="username">生日</a>
							</th>
							<th style="text-align:center">
								<a href="javascript:;" class="sort" name="email">手机号码</a>
							</th>
							<th style="text-align:center">
								<a href="javascript:;" class="sort" name="name">所属公司</a>
							</th>
							<th style="text-align:center">
						...
						[#list page.content as driver]
							<tr>
								<td>
									<input type="checkbox" name="ids" value="${driver.id}" />
								</td>
								<td>
									${driver.driverName}
								</td>
								...
								<td>
									<span title="${driver.createDate?string("yyyy-MM-dd HH:mm:ss")}">${driver.createDate}</span>
								</td>
								
								
								<td>
									<a href="view.jhtml?id=${driver.id}" class="layui-btn layui-btn-xs">查看</a>
								</td>
							</tr>
						[/#list]
