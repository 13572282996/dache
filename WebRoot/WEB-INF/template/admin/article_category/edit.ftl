...
<tr>
			...
			<tr>
				<th>
					<span class="requiredField">*</span>英文名:
				</th>
				<td>
					<input type="text" name="enName" class="text" value="${articleCategory.enName}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<select name="parentId">
						<option value=""><!--${message("admin.articleCategory.root")}-->Category parent</option>
						[#list articleCategoryTree as category]
						[#if category.grade <=2]
							[#if articleCategory.id != category.id]
								[#if articleCategory.parent != null]
									[#if articleCategory.parent.id == category.id]
			...
			<tr>
				...
				<td>
					<input type="text" name="beforePath" class="text" value="${articleCategory.beforePath}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
