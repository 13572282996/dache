...
<form id="inputForm" action="save.jhtml" class="form-inline" method="post">
    ...
    <table class="table" id="addEditTable">
    	        <tr>
					...
					<td>
						<input type="radio" name="type" class="radio" value="realTime" checked />实时
						<input type="radio" name="type" class="radio" value="appointment"  />预约
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<input type="radio" name="carType" class="radio" value="comfort" checked />舒适型
						<input type="radio" name="carType" class="radio" value="luxury"  />豪华型
						<input type="radio" name="carType" class="radio" value="business"  />商务型
					</td>
				</tr>
				 <tr>
					<th>
					...
					<td>
						<input type="text" id="basePrice" name="basePrice" class="text" maxlength="20" />
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<input type="text" id="miles" name="miles" class="text" maxlength="20" />
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<input type="text" name="baseTime" class="text" maxlength="200" />
					</td>
				</tr>
				<tr class="roles">
					<th>
					...
					<td>
						<input type="text" name="milPrice" class="text" maxlength="200" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="timePrice" class="text" maxlength="200" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="haulbackMil" class="text" maxlength="200" />
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<input type="text" name="haulbackPrice" class="text" maxlength="200" />
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<input type="text" name="nightPrice" class="text" maxlength="200" />
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<input type="text" name="morningPeak" class="text" maxlength="200" />
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<input type="text" name="nightPeak" class="text" maxlength="200" />
					</td>
				</tr>
				<tr>
					<th>&nbsp;</th>
